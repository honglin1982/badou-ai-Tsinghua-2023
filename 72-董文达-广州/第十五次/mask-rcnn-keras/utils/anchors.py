...
def generate_pyramid_anchors(scales, ratios, feature_shapes, feature_strides, anchore_stride):
    anchors = []
    for i in range(len(scales)):
        anchors.append(generate_anchors(scales[i], ratios, feature_shapes[i], feature_strides[i], anchore_stride))
