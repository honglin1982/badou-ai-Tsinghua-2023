...
#BatchNormalization类实现批归一化的功能
class BatchNormalization(Layer):
    
    #初始化BatchNormalization类的参数
    ...
    def build(self, input_shape):
        ...
        self.built = True
    #定义了批量归一化层的前向传播过程，根据输入的形状和参数进行归一化操作
...
def classifier_layers(x, input_shape, trainable=False):
    ...
    return x
#定义了输入张量的形状，并使用 ​ResNet50(inputs)​创建了一个基于 ​ResNet50的模型，打印出模型的摘要信息
